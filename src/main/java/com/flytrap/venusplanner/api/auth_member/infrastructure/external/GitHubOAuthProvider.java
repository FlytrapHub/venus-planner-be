...
import com.flytrap.venusplanner.api.auth_member.exception.GitHubOAuthRequestFailureException;
...
public class GitHubOAuthProvider implements OAuthProvider {
     ...
     * @throws GitHubOAuthRequestFailureException GitHub 요청 과정에서 오류가 발생했을 때 발생합니다.
     ...
     * {@link GitHubOAuthRequestFailureException}을 발생시킵니다.
     * <p>
     * @param code GitHub OAuth 인증 과정에서 얻은 인증 코드
     * @return 액세스 토큰 정보를 담고 있는 {@link AccessTokenFromGitHub}
     * @throws GitHubOAuthRequestFailureException GitHub OAuth 요청 과정에서 발생하는 모든 예외를 포함합니다.
        ...
        return gitHubAccessTokenClient
                ...
                .onStatus(
                        ...
                        response -> response.bodyToMono(String.class)
                                        .flatMap(body -> Mono.error(new GitHubOAuthRequestFailureException(body))))
                .bodyToMono(AccessTokenFromGitHub.class)
                .doOnError(error -> log.error("GitHub에서 액세스 토큰을 요청하는 중 에러 발생", error))
                .onErrorMap(throwable -> new GitHubOAuthRequestFailureException(throwable.getMessage()))
                .block();
    }
     ...
     * {@link GitHubOAuthRequestFailureException}을 Mono.error()로 반환합니다.
     * <p>
